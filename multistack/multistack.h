...
public:
	...
	T Get(int i); //Ïîëó÷åíèå ýëåìåíòà

	void Push(T d, int i); //Âñòàâêà ýëåìåíòà
	bool IsEmpty(int i) const; // êîíòðîëü ïóñòîòû
	bool IsFull(int i) const; //êîíòðîëü ïåðåïîëíåíèÿ
	int GetSize();
